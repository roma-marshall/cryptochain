<template>
  <main class="p-4 md:ml-64 h-auto pt-20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
      <div
          class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 min-h-48 md:min-h-72"
      >
        <TotalChart />
      </div>
      <div
...
import TotalChart from './TotalChart.vue'  // connecting Pinia Store
